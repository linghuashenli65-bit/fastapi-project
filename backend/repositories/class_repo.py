...
from backend.models.student_class import Student_Class
from backend.models.teacher import Teacher
from backend.models.teacher_class import Teacher_Class
from backend.schemas.Class import ClassCreate, ClassUpdate

class ClassRepo(BaseCRUD[Class, ClassCreate, ClassUpdate]):
    def __init__(self):
